...
bool DomainLawyer::AddShard(
  ...
  handler->Message(kInfo,"ST=> AddShard shard_domain_name =%s and comma_separated_shards =%s",shard_domain_name.as_string().c_str(),comma_separated_shards.as_string().c_str());
  return result;
}
